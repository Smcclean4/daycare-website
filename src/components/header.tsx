    ...
    <div className="flex justify-between z-10 max-h-50 w-full absolute">
      <Link href="/home">
        <div className="h-35 md:h-40 lg:h-45 xl:h-55 2xl:h-60 w-35 md:w-40 lg:w-45 xl:w-55 2xl:w-60 relative" onClick={() => setActiveTabIndex(0)}>
          <Image
            src="/IMG_0059.PNG"
            className={`absolute bg-gray-100/70 ${activeTabIndex === 1 ? 'left-12 md:left-24 lg:left-36 rounded-b-xl' : 'rounded-br-xl'} `}
            width={300}
            height={300}
      ...
      >
        <div className={`flex flex-col items-center w-full md:w-2/4 pl-10 py-10 text-black h-auto md:p-0 md:bg-transparent`}>
          <div className={`inline-flex flex-col md:flex-row space-y-20 md:space-y-0 md:space-x-10 lg:space-x-20 mr-20 md:mr-10 mt-10 md:ml-20 text-xl font-mono cursor-pointer py-2 px-6 rounded-xl ${activeTabIndex === 1 ? 'bg-white/60' : 'bg-transparent'}`}>
