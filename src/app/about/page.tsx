...
const setActiveTabColor = (index: number) => {
  ...
  return (
    <div className="h-auto min-h-275 lg:h-screen w-full flex justify-between flex-row lg:flex-col flex-wrap items-center bg-gradient-to-b from-purple-100/75 to-purple-300/75 pb-12 relative pt-20">
      ...
      <div className="flex flex-row lg:flex-col text-center justify-between items-center relative h-3/4 w-3/4  lg:w-1/2">
      <p className="md:m-0 text-3xl md:text-4xl lg:text-5xl text-purple-800" style={{fontFamily: "Edu NSW ACT Cursive"}}>Hi, my name is Shiromi!</p>
      <Image
            src="/download (2).jpeg"
            alt="Profile Photo"
            className="rounded-full my-10 md:my-20 lg:m-10 xl:m-0 object-cover aspect-square border-8 border-white/80"
            width="400"
            height="100"
          />
      </div>
        <div className="flex flex-wrap justify-around items-center w-full md:w-4/5 align-center text-lg">
            <div className="w-4/5">
              ...
              <div className="bg-purple-300 min-h-96 rounded-b-lg border-t-1 xl:min-w-132 border-white border-r-1">
