...
export default function Home() {
  ...
  const homeScrollImage = ["/IMG_4036.jpg", "/IMG_4391.jpg", "/IMG_6950.jpg", "/IMG_9894_Facetune_17-07-2022-17-10-36.jpg"];
  ...
  return (
    <div className="flex justify-center items-center -z-40 relative h-screen pt-40 bg-blue-400/70">
      <div className="flex flex-col md:flex-row justify-center items-center bg-gray-200/75 h-auto lg:4/5 rounded-lg z-50 w-7/8 text-black p-10">
        ...
        <div className="flex flex-col w-full lg:w-3/4">
          <h3 className="text-sm lg:text-xl xl:text-xl 2xl:text-2xl font-mono">Welcome to <span className="text-purple-500 underline drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">Fernando</span> <span className="text-purple-500 underline drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">Family</span> <span className="text-purple-500 underline drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">Daycare</span>! Here, we offer more than just babysitting — we provide a loving, supportive family environment where your child’s emotional and developmental needs are met. With activities like music, outdoor play, arts and crafts, and more, your child will receive the care and attention they deserve. You can have peace of mind knowing they are in a safe, nurturing home, treated with respect and love. Thank you for visiting, and I look forward to making your child’s early years filled with joy and growth.</h3>
        </div>
      </div>
