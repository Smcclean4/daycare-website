...
export default function Contact() {
    return (
        <div className="h-screen flex flex-col lg:flex-row text-center justify-around items-center text-gray-900">
            ...
            <div className="flex flex-col items-center justify-around text-center h-full w-full lg:w-auto bg-green-700/75 text-white italic text-2xl">
                <div className="min-h-2/4 w-6/7 md:w-3/4">
                    <ul className="text-left w-full h-auto flex flex-col justify-center">
                        ...
                        <li className="p-1 list-disc"><span className="underline text-bold underline-offset-2">Phone Number:</span> (310) 532-7529  /   (310) 293-3883</li>
